...
public class Transactions extends JFrame implements ActionListener{
    ...
    Transactions(String pinnumber){
        ...
        deposit.addActionListener(this);  //to perform action
        image.add(deposit);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==exit){
            ...
            setVisible(false); //when click on deposit go to other frame... so close this
            ...
            // setVisible(false); is not used bcoz i want the main page also to remain
